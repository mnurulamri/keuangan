...
class Realisasi_ajax extends CI_Controller {
...
//print_r($kode_dpsj); exit();
        ...
        if(!empty($params['search']['keywords'])){
            ...
            /*if ($status === 'Semua') {
                # code...
                $where = "WHERE deskripsi LIKE '%$keywords%'";
            } else {
                # code...                
                $where = "WHERE deskripsi LIKE '%$keywords%' AND status = '$status'";
            }*/
			
			$where = "WHERE kode_dpsj IN ($kode_dpsj) AND nomor_pengajuan LIKE '%$keywords%' AND kode_status IN ('41', '42', '52', '67')";
            ...
            # menghitung jumlah record
			$where = "WHERE kode_dpsj IN ($kode_dpsj) AND kode_status IN ('41', '42', '52', '67')";
            $sql_count = "SELECT id FROM monitoring $where";
        }
        ...
        $sql = "SELECT * FROM monitoring $where ORDER BY id DESC $limit";
        ...
        */
        ...
        # load the view
        $this->load->view('unit_kerja/realisasi-ajax-data', $data, false);
