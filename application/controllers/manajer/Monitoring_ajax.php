...
class Monitoring_ajax extends CI_Controller {
    ...
    public  function data()
    {
        ...
        $where = "WHERE kode_status >= 21"; // set default where clause for kode_status >= 21
        ...
        $config['base_url']    = 'manajer/monitoring_ajax';
        ...
        # load the view
        $this->load->view('manajer/monitoring-ajax-data', $data, false);
    }
}