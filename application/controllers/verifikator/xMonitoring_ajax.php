...
//print_r($kode_dpsj); exit();
        ...
        # get records
        $sql_monitoring = "SELECT DISTINCT a.*, a.id_pengajuan_pemohon, c. id_pengajuan_rincian, d.kode_bidang as kode_bidang, e.nama_unit as nama_unit
                FROM monitoring a, pengajuan_rincian b, realisasi c, pengajuan_pemohon d,unit_kerja e
                $WHERE $order_by $limit";
        $query = $this->db->query($sql_monitoring); //$query = $this->db->get();
