...
class Monitoring extends CI_Controller {
    ...
    public function approval() {
        ...
        $data = array(
            ...
            'korpum_tgl_disetujui' => $korpum_tanggal.' '.$korpum_waktu,
    ...
    public function detailApproval() {
        ...
        $query = $this->db->query($sql, array($id_pengajuan_pemohon));
        $monitoring = $query->row_array();
        $data['korpum_tgl_disetujui'] = $this->dateTimeToTanggalWaktu($monitoring['korpum_tgl_disetujui']) ?? null;
        $data['korpum_keterangan'] = $monitoring['korpum_keterangan_disetujui'] ?? null;
