...
class Pengajuan extends CI_Controller {
    ...
    public function form() {
		...
		$data['sql'] = $sql;
        //$data['kode_dpsj'] = $this->session->userdata('logged_anggaran')['kode_dpsj'];
        ...
        if ($this->form_validation->run() === FALSE) {
            $this->load->view('template/header', $data);
            $this->load->view('template/tes_menu', array('menu' => menu()) );
            $this->load->view('unit_kerja/form_pengajuan_d01', $data);
            //$this->load->view('anggaran/pengajuan', $data);            
            $this->load->view('template/footer');
			//$this->load->view('anggaran/pengajuan_script');
            $this->load->view('unit_kerja/form_pengajuan_d01_script');
        } else {
            // Get kode unit
