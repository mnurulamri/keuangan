...
class Sisa_anggaran extends CI_Controller {
	...
	public function index(){
        ...
        $query = $this->db->query($sql, array($tahun_anggaran, $kode_dpsj, $kode_kegiatan, $kode_akun, $kode_dana));*/

        /*$sql = "SELECT sisa_anggaran 
                FROM view_anggaran_mutasi 
                WHERE tahun_anggaran = '$tahun_anggaran' AND kode_dpsj = '$kode_dpsj' AND kode_kegiatan = '$kode_kegiatan' AND kode_akun = '$kode_akun' AND kode_dana = '$kode_dana' AND flag_payroll IN ('Procost Unit')
                UNION ALL
                SELECT sisa_anggaran 
                FROM view_anggaran_mutasi 
                WHERE tahun_anggaran = '$tahun_anggaran' AND kode_kegiatan = '$kode_kegiatan' AND kode_akun = '$kode_akun' AND kode_dana = '$kode_dana' AND flag_payroll IN ('Procost Umum')
                ";*/
        $sql = "SELECT sisa_anggaran 
                FROM view_anggaran_mutasi 
