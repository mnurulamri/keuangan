...
class Monitoring_ajax extends CI_Controller {
    ...
    public  function data()
    {
        ...
        if ($status == 'Diretur'){
			...
			$where .= " AND a.kode_status IN (11,13,21,31,41,51,61,71) AND a.nomor_pengajuan LIKE '%$keywords%'";
		} else if ($status == '1'){
			$where .= " AND a.kode_status IN (1,10) AND a.nomor_pengajuan LIKE '%$keywords%'";
		} else {
