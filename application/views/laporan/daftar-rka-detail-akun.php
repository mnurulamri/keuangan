...
<h4 class="text-center" style="text-align:center; color:#43A5BE"><?=$result_dpsj->deskripsi_dpsj?> - <?=$result_dpsj->nama_unit?></h4>

<table class="styled-table" id="tabel">
	<thead>
    <tr>
        <th style="background:#fff; border:none" colspan="2"><input type="text" id="nomor_pengajuan-search" onkeyup="search()" placeholder="Filter Nomor Pengajuan.." class="table-search-filters-modal"></th>
        <th style="background:#fff; border:none"><input type="text" id="kode_kegiatan-search" onkeyup="search()" placeholder="Filter Kode Kegiatan.." class="table-search-filters-modal"></th>
        <th style="background:#fff; border:none"></th>
        <th style="background:#fff; border:none"></th>
        <th style="background:#fff; border:none"><input type="text" id="kode_akun-search" onkeyup="search()" placeholder="Filter Kode Akun.." class="table-search-filters-modal""></th>
        <th style="background:#fff; border:none"></th>
        <th style="background:#fff; border:none"></th>
    </tr>
	<tr class="header">
	...
	<tbody>
		...
		foreach($result as $row){
			...
			<tr class="item">
                ...
                <td>'.$row['form'].'</td>
                <td>'.substr($row['anggaran_tgl_disetujui'], 0, 10).'</td>
			</tr>
			';
		}
		?>
