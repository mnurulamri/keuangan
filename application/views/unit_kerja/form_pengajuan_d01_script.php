...
$(document).ready(function() {
    ...
    $("#deskripsi_dpsj").click(function()
    {
        ...
        var tahun_anggaran = $("#tahun").val();
            ...
            $.ajax({
                ...
                type: "POST",
                data: {kata:kata, kode_bidang:kode_bidang, tahun_anggaran:tahun_anggaran},
    ...
    $(document).on("click", "#simpan", function(e){
        ...
        {
            //var tahun_anggaran = tahun_anggaran;
            //var tahun = $("#tahun").val();
            //var bulan = $("#bulan").val();
            var kode_dpsj = $("#kode_dpsj").text();
        ...
        array_pejabat.push({
            ...
            nip: $('input#nip').val(),
            telp: $('input#telepon').val(),
            untuk: $('input#untuk').val(),
            form: nama_form,
            tgl_diajukan: tgl_diajukan
        });
        //console.log(array_pejabat); return false;
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                location.href = "../pengajuan_ajax/?kode_status=Semua";
                console.log(response);
            },
            error: function(xhr, status, error) {
                // Tampilkan pesan kesalahan
...
function lock_data(tahun, bulan)
{      
    var tahun = $("#tahun").val();
    var bulan = $("#bulan").val();
