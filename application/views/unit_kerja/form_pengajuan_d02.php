...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <?= $title ?>
            <small>Formulir Permohonan Pembayaran</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="hidden" name="nama_form" id="nama_form" value="D02">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                    <div class="input-group">                                                
                                                        ...
                                                        if ($i==1) {
                                                            echo'
                                                            <input type="text" class="form-control deskripsi_dpsj" id="deskripsi_dpsj" name="deskripsi_dpsj" autocomplete="off" size="100" value="'.$array_dpsj[0]['deskripsi_dpsj'].'">
