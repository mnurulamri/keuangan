...
$(document).ready(function()
{
	...
	$(document).on("click",".ajukan", function(){
        ...
        $.ajax({
            url: "<?=base_url()?>index.php/daftar_pengajuan/preview",
            type: "POST",
	...
	$(document).on("click","#ajukan", function(){
		...
		// ambil data form edit pengajuan menggunakan AJAX
        $.ajax({
            url: "<?=base_url()?>index.php/daftar_pengajuan/rubahStatusPengajuan",
            type: "POST",
            data: {nomor_pengajuan: nomor_pengajuan, status: 'ajukan'},
            success: function(response) {
