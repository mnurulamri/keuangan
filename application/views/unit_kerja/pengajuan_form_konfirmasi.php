<?php
//echo '<pre>';
//print_r($id_pengajuan_pemohon);
//echo '</pre>';
$tgl_diajukan = substr($tanggal, 0, 10);
?>


                <input type="hidden" name="nama_form" id="nama_form" value="<?php echo $form; ?>">
                            ...
                            <div class="box-body">                                
                                <div class="row">                                    
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="nomor_pengajuan" name="nomor_pengajuan" value="<?= $preview_nomor ?>" style="background-color:#fff" readonly>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">                                              
                                            <input type="text" class="form-control" id="tanggal" name="tanggal" value="<?= dbToTanggal($tgl_diajukan) ?>" style="background-color:#fff" disabled  >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="unit_id" class="col-sm-4 control-label text-right" text-right>PAF/Dept/Prog/Unit</label>
                                        <div class="col-sm-8">                                                
                                            <input type="text" class="form-control" id="nama_unit" name="nama_unit" value="<?= $nama_unit ?>" style="background-color:#fff" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                echo '<input type="text" class="form-control" id="penanggung_jawab" name="penanggung_jawab" value="'.$penanggung_jawab.'" style="background-color:#fff" readonly>' ;                              
                                                ?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                echo '<input type="text" class="form-control" id="nip" name="nip" value="'.$nip.'" style="background-color:#fff" readonly>';
                                                ?>    
                                            </div>                                            
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                echo '<input type="text" class="form-control" id="telepon" name="telepon" value="'.$telp.'" style="background-color:#fff" readonly>';
                                                ?>
                                            </div>                                                    
                                        </div>
                                    </div>
                            ...
                            <div class="box-body" style="overflow:auto">
                                <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="untuk" name="untuk" value="<?= $untuk ?>" style="background-color:#fff" readonly >
                                            </div>
                                        </div>                                    
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9 col-md-9 col-lg-9">
                                                    ...
                                                    echo'
                                                        <input type="text" class="form-control deskripsi_dpsj" id="deskripsi_dpsjx" name="deskripsi_dpsj" autocomplete="off" size="150" value="'.$deskripsi_dpsj.'" style="background-color:#fff" readonly >
                                                        <span class="input-group-addon" id="kode_dpsj" style="width:145px; background-color:#fff" readonly>'.$kode_dpsj.'</span>';
                                        ...
                                        <table class="tablex table-borderedx" border="1" id="tabel-rincian">
                                            ...
                                            <tbody>
                                                ...
                                                foreach($rincian as $row){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="sisa_anggaran" id="sisa_anggaran_'.$newId.'">'.$sisa_anggaran[$kode_kegiatan][$kode_akun][$kode_dana].'</td>
                                                    </tr>';
                                                    $rowCount++;
                                                    $newId++;    
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td class="total"><?=number_format($komitmen)?></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="9" style="border: 1px solid #fff; text-align: center; background-color: #fff;">
                                                        <?php
                                                        /*if ($j==1){
                                                            $disabled = '';
                                                        } else {
                                                        ...
                                                        ?>                                                 
                                                        <button class="btn btn-primary btn-sm" id="ajukan" data-id_pengajuan_pemohon="<?= $id_pengajuan_pemohon ?>" data-nominal_pengajuan="<?=$komitmen?>" data-nama_form="<?=$form?>" ><i class="fa fa-paper-plane"></i> Ajukan </button>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
