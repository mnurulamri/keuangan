                            ...
                            <div class="box-body" style="overflow:auto">
                                <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="untuk" name="untuk" value="<?= $untuk ?>" >
                                            </div>
                                        </div>                                    
                                    <div class="col-sm-12">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <td colspan="9" style="border: 1px solid #fff">
                                                        ...
                                                        ?>                                                 
                                                        <button class="btn btn-primary btn-sm" id="ajukan" data-id_pengajuan_pemohon="<?= $id_pengajuan_pemohon ?>" data-nominal_pengajuan="<?=$komitmen?>"><i class="fa fa-paper-plane"></i> Ajukan </button>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
