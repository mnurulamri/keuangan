...
if (!$this->session->userdata('kode_bidang')) {
    ...
    $deskripsi_dpsj = $array_dpsj[0]['deskripsi_dpsj'];
    $kode_unit = $array_dpsj[0]['kode_unit'];
    $kode_bidang = $array_dpsj[0]['kode_bidang'];
    $nama_unit = $array_dpsj[0]['nama_unit'];
    $array_test[0] = array('kode_dpsj' => $kode_dpsj, 'deskripsi_dpsj' => $deskripsi_dpsj, 'kode_unit' => $kode_unit, 'kode_bidang' => $kode_bidang,  'nama_unit' => $nama_unit);
	$array_dpsj = $this->session->userdata('logged_anggaran')['array_dpsj'];
    $tgl_diajukan = substr($tgl_diajukan, 0, 10);
   //echo '<pre>';print_r($tgl_diajukan);echo '</pre>';
?>
                            ...
                            <div class="box-body">                                
                                <div class="row">                                    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">                                                
                                            <input type="date" class="form-control" id="tanggal" name="tanggal" value="<?= $tgl_diajukan ?>" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                echo '<input type="text" class="form-control" id="penanggung_jawab" name="penanggung_jawab" value="'.$pejabat[0]['nama'].'">';
            ...
            <div class="row text-center">
                <div class="form-group form-inline col-sm-12">
                    ...
                    <select name="tahun" id="tahun" class="form-control" >
                        <?php echo optTahun($tahun_edit); ?>
                    </select>
                    <label for="bulan" class=" control-label text-right">Bulan</label>
                    <select name="bulan" id="bulan" class="form-control">
                        <?php echo optBulan($bulan_edit); ?>
                    </select>
                </div>                                   
            </div>
                                    <div class="col-sm-12 kotak" id="data-rincian-pengajuan">
                                      ...
                                      <div class="box-header with-border text-center" style="line-height:7px"><b>Rincian Pembayaran</b></div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                    <div class="input-group">                                                
                                                        ...
                                                        if ($i==1) {
                                                            echo'
                                                            <input type="text" class="form-control deskripsi_dpsj" id="deskripsi_dpsj" name="deskripsi_dpsj" autocomplete="off" value="'.$atas_nama.'" >
                                                            <span class="input-group-addon" id="kode_dpsj" style="width:145px; background-color:#ddd" readonly>'.$kode_dpsj_edit.'</span>
                                                        ...
                                                        <!--<input type="text" class="form-control deskripsi_dpsj" id="deskripsi_dpsj" name="deskripsi_dpsj" autocomplete="off" size="100" value="<?=$deskripsi_dpsj?>" >
                                        ...
                                        <input type="hidden" id="id_pengajuan_rincian" value="0" >
                                        ...
                                        <table class="tablex table-borderedx" border="1" id="tabel-rincian">
                                            ...
                                            <tbody>
                                                ...
                                                $kode_dpsj = $kode_dpsj_edit; //$array_dpsj[0]['kode_dpsj'];
                                                $nominal_pengajuan = 0;
                                                foreach($rincian as $row){
                                                    ...
                                                    $kode_dana = (string)$row['kode_dana'];
                                                    $key = $kode_kegiatan.$kode_akun.$kode_dana;
                                                    $id_pengajuan_rincian = $row['id'];
                                                    ...
                                                    echo '
                                                    <tr>
                                                        <td class="text-center" id="'.$row['id'].'">'.$rowCount.'</td>
                                                        <td class="kode-kegiatan text-center" id="kode_kegiatan_'.$newId.'">'.$row['kode_kegiatan'].'</td>
                                                        <td class="nama-kegiatan text-left" data-id="'.$newId.'">'.$row['nama_kegiatan'].'</td>
                                                        ...
                                                        <td class="jumlah text-right" id="jumlah_'.$newId.'" data-id_pengajuan_rincian="'.$id_pengajuan_rincian.'">'.number_format($row['komitmen']).'</td>
                                                        <td class="keterangan" contenteditable="true">'.$row['keterangan'].'</td>
                                                        <td class="sisa_anggaran text-right" id="sisa_anggaran_'.$newId.'">'.$test_sisa[$key].'</td>
                                                        <!--<td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="6" class="text-right" style="border: 1px solid #fff;"><b>Total: </b></td>
                                                    <td class="total text-right"><?=number_format($nominal_pengajuan)?></td>
                                                    <td style="border: 1px solid #fff;"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="10" style="border: 1px solid #fff; text-align: center; background-color: #fff;">
                                                        <?php
                                                        if ($j==1){
                                                            $disabled = '';
                                                        } else {
