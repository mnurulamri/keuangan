...
if (!$this->session->userdata('kode_bidang')) {
    ...
    echo 'Kode Bidang tidak ditemukan di session. Silakan pilih unit kerja terlebih dahulu.';    
    ...
    //echo '<pre>';print_r($array_dpsj);print_r($array_test);echo '</pre>';
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <?= $title ?>
            <small>Formulir Permohonan Dana</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <input type="hidden" name="nama_form" id="nama_form" value="D01">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                if ($i==1) {
                                                    ...
                                                    // jika tidak ada maka kosongkan value
                                                    if(isset($pejabat[0]['nip'])){
                                                        $nip_value = $pejabat[0]['nip'];
                                                    } else {
                                                        $nip_value = '';
                                                    }                                                  
                                                    echo '<input type="text" class="form-control" id="nip" name="nip" value="'.$nip_value.'">';
                                                }  
                                                ?>    
                                            </div>                                            
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                if ($i==1) {
                                                    ...
                                                    if(isset($pejabat[0]['telp'])){
                                                        $telp_value = $pejabat[0]['telp'];
                                                    } else {
                                                        $telp_value = '';
                                                    }
                                                    echo '<input type="text" class="form-control" id="telepon" name="telepon" value="'.$telp_value.'">';
                                                }  
                                                ?>
                                            </div>                                                    
                                        </div>
                    ...
                    <select name="bulan" id="bulan" class="form-control" >
                        ...
                        <!--<div class="box box-primary">
                            ...
                            <div class="box-body" style="overflow:auto">-->
                                <div class="row" id="data-rincian-pengajuan">
                                            ...
                                            <div class="col-sm-9">
                                                    <div class="input-group">                                                
                                                        ...
                                                        if ($i==1) {
                                                            ...
                                                            <span class="input-group-addon" id="kode_dpsj" style="width:145px; background-color:#ddd" readonly>'.$kode_dpsj[0].'</span>
                                                            <!--<span class="input-group-addon btn btn-danger" id="clear_dpsj">clear</span>-->';
                                                        } else { ?>                                                
                                                            <input type="text" class="form-control deskripsi_dpsj" id="deskripsi_dpsj" name="deskripsi_dpsj" autocomplete="off" size="100" >
...
.kotaksugest_pc {
    ...
    overflow-y: auto;
    overflow-x: hidden;
    position: absolute; /* Pastikan posisinya relatif terhadap parent */
    z-index: 1000;
    background: #fff;
    border: 1px solid #ddd;
    width: 100%;
