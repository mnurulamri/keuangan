...
$(document).ready(function()
{
    ...
    $(document).on("click", "#deskripsi_dpsj", function() 
    {
    ...
    $(document).on("click", "#btn-add-row", function() {        
        ...
        var newRow = '<tr>' +
            '<td class="text-center" id="99999999999">' + rowCount + '</td>' +
            '<td class="kode-kegiatan text-center" id="kode_kegiatan_'+newId+'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>' +
            '<td class="nama-kegiatan text-left" data-id="'+newId+'"><input type="text" name="nama_kegiatan[]" class="form-control nama-kegiatan project-costing hovertext" title="" placeholder="Cari project costing..." autocomplete="off"></td>' +
            '<td class="kode-akun text-center" id="kode_akun_'+newId+'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>' +
            '<td class="deskripsi-akun text-left" id="akun_'+newId+'" data-id="'+newId+'"><input type="text" name="deskripsi_akun[]" class="form-control akun" placeholder="Cari akun..." disabled autocomplete="off" data-id="'+newId+'"></td>' +
            '<td class="kode-dana text-center" id="dana_'+newId+'">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>' +
            '<td class="jumlah text-right" id="jumlah_'+newId+'"><input type="text" name="jumlah[]" class="form-control money input-jumlah" data-id="jumlah_'+newId+'" value="0"></td>' +
            '<td class="keterangan text-left" contenteditable="true"></td>' +
            '<td class="sisa_anggaran text-right" id="sisa_anggaran_'+newId+'"></td>' +
            '<td class="text-center"><button type="button" class="btn btn-danger btn-xs btn-remove-row"><i class="fa fa-times"></i></button></td>' +
            '</tr>';
    ...
    $(document).on("click", ".nama-kegiatan", function()
    {
		...
		$(this).html('<input type="text" name="nama_kegiatan[]" class="form-control project-costing hovertext" title="" placeholder="Cari project costing..." value="'+nama_kegiatan+'" autocomplete="off">');
    ...
    $(document).on("click", ".deskripsi-akun", function()
    {
		...
		$(this).html('<input type="text" name="deskripsi_akun[]" class="form-control akun hovertext" title="" placeholder="Cari project costing..." value="'+deskripsi_akun+'" data-id="'+id+'" autocomplete="off">');
		$(".akun").select();
    ...
    */
    ...
    $(document).on("click", ".jumlah", function(){
        ...
        if (jumlah_element == 0) {
            ...
            $(this).html('<input type="text" name="jumlah[]" class="form-control money input-jumlah" value="'+jumlah+'" data-id="'+id_jumlah+'" value="0" autocomplete="off">');
            $(".input-jumlah").select();
            console.log('id_jumlah:'+id_jumlah);
            var id_pengajuan_rincian = $(this).data("id_pengajuan_rincian");
            $("#id_pengajuan_rincian").val(id_pengajuan_rincian);
        } else {
            return;
        }
    ...
    $(document).on("blur", ".input-jumlah", function(){
        ...
        var id_pengajuan_rincian = $("#id_pengajuan_rincian").val();
        ...
        $.ajax({
            url: "<?=base_url()?>Sisa_anggaran_form_edit",
            type: "POST",
            data: {tahun_anggaran: tahun_anggaran, kode_dpsj: kode_dpsj, kode_kegiatan:kode_kegiatan, kode_akun:kode_akun, kode_dana:kode_dana, jumlah:jumlah, id_pengajuan_rincian:id_pengajuan_rincian},
            //dataType: 'json',
            success: function(response) {
                // Tampilkan pesan sukses atau lakukan tindakan lain
