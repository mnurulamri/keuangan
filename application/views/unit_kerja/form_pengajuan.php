...
//echo '<pre>';print_r($sisa_anggaran);echo '</pre>';
?>
                            ...
                            <div class="box-body" style="overflow:auto">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            <label for="untuk_nama" class="col-sm-3 control-label text-right">Untuk dan Atas Nama</label>
                                            <div class="col-sm-9">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <td colspan="9" style="border: 1px solid #fff">
                                                        ...
                                                        ?>                                                 
                                                        <button class="btn btn-primary btn-sm" id="ajukan" data-nomor_pengajuan="<?= $preview_nomor ?>"><i class="fa fa-paper-plane"></i> Ajukan </button>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
