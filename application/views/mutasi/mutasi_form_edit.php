...
//echo '<pre>'; print_r($deskripsi_dpsj); echo '</pre>';//exit;
?>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <div id="data-rincian-mutasi">
                        ...
                        <div class="col-sm-9">
                                <div class="input-group">                                                
                                    ...
                                    if ($i==1) {
                                        ...
                                        <input type="text" class="form-control deskripsi_dpsj" id="deskripsi_dpsj" name="deskripsi_dpsj" autocomplete="off" value="<?= $deskripsi_dpsj ?>">
                ...
                <!--<input type="number" value="0" id="test-number" inputmode="numeric" pattern="[0-9]*"/> -->

                <!-- Di bagian Rincian Pembayaran -->
                <table class="tablex table-borderedx" border="0" id="tabel-rincian">
                    <thead>
                        <tr>
                            <th width="5%">No</th>
                    ...
                    <tbody>
                        ...
                        foreach($result as $row){
                            ...
                            <tr>
                                ...
                                <td class="kategori-kegiatan" id="kategori_kegiatan_'.$newId.'">'.$row['kategori_kegiatan'].'</td>
                                ...
                                <td class="sisa_anggaran text-right" id="sisa_anggaran_'.$newId.'">'.number_format($row['sisa_anggaran']).'</td>
                                <!--<td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="7" style="border: 1px solid #fff; background-color: #fff"></td>
                            <td class="total"><?=number_format($nominal_pengajuan)?></td>
                        </tr>
                        <tr>
                            <td colspan="10" style="border: 1px solid #fff; background-color: #fff">
                                <?php
                                if ($j==1){
                                    $disabled = '';
                                } else {
                                ...
                                <button class="btn btn-success btn-sm" id="simpan" data-id_pengajuan_pemohon="<?=$id_pengajuan_pemohon?>" data-kode_grup="<?=$kode_grup?>" ><i class="fa fa-floppy-o"></i> Simpan</button>
                            </td>
                        </tr>
                        <!--
                        <tr>
