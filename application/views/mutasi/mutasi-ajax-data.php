        ...
        foreach($posts as $key => $value) {
            ...
            <tr id="'.$toggleHeadId.'">
                ...
                <td>
                    ...
                    <button class="btn btn-success btn-xs edit" data-kode_grup="'.$value['kode_grup'].'" data-kode_dpsj="'.$value['kode_dpsj'].'" data-id_pengajuan_pemohon="'.$value['id_pengajuan_pemohon'].'" data-toggle="custom-modal" data-target="customModal" '.$disabled.'>edit</button>
