    ...
    <div class="row" style="width:99%; margin:0 auto;">
        ...
        <div class="col-sm-12 kotak">
            ...
            <div id="approvalForm" class="text-center">
                ...
                <button class="btn btn-success" id="setujui" data-id_pengajuan_pemohon="<?=$id_pengajuan_pemohon?>"  data-id_monitoring="<?=$id_monitoring?>"><i class="fa fa-check"></i> Disetujui </button>
                <button class="btn btn-warning" id="pending" data-id_pengajuan_pemohon="<?=$id_pengajuan_pemohon?>"  data-id_monitoring="<?=$id_monitoring?>"><i class="fa fa-undo"></i> Dipending </button>
...
$(document).ready(function()
{
    ...
    $('#pending').on('click', function() {       
		...
		if (!confirm("Apakah Anda yakin akan menunda data pengajuan ini?")) {
			return false;
		} else {
            var id_monitoring = $(this).data('id_monitoring');
            var id_pengajuan_pemohon = '<?=$id_pengajuan_pemohon?>';
