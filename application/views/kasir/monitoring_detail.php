                            ...
                            <div id="approvalForm" class="text-center">
                                <form class="form-horizontal">                                    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-3">
                                            <input class="form-control" id="nominal_umko_cair" name="nominal_umko_cair" size="10" value="<?=number_format($nominal_umko_cair)?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="kasir_tgl_disetujui" class="control-label col-xs-4" style="color:#555">Tanggal Penyerahan :</label>
                                        <div class="col-xs-3">
                                            <input class="form-control" id="kasir_tgl_disetujui" name="kasir_tgl_disetujui" size="10" value="<?=dateTimeToTanggal($kasir_tgl_disetujui)?>" />
                                        </div>
                                    </div> 
                                    <!--
                                    <div class="form-group">
