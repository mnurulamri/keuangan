   ...
   <hr>
    <div class="row" style="width:99%; margin:0 auto;">
        ...
        if($result_monitoring[0]['kode_status'] == 51) {
            $kasir_keterangan = isset($result_monitoring[0]['kasir_keterangan_disetujui']) ? $result_monitoring[0]['kasir_keterangan_disetujui'] : '';
        } else if($result_monitoring[0]['kode_status'] == 42) {            
            $kasir_keterangan = isset($result_monitoring[0]['kasir_keterangan_pending']) ? $result_monitoring[0]['kasir_keterangan_pending'] : '';
        } else {
            $kasir_keterangan = '';
        }
        ?>
...
$(document).ready(function()
{
    ...
    $('.approval').on('click', function() {
        ...
        $.ajax({
            url: '<?=base_url("kasir/pengajuan/approval")?>',
            type: 'POST',
            data: {
    ...
    $("#retur").click(function(){
        var id_monitoring = $(this).data('id_monitoring');
        kendali_dokumen(flag_approve='Pending', id_monitoring);
    });
