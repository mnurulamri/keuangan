...
{  
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>kasir/pengajuan/data/0',  //url: '<?php echo base_url(); ?>koordinator/ajax/'+page_num,
...
function getDataPage(page){              
    ...
    $url = "<?=base_url().'kasir/pengajuan/data/'?>"+page;
	$.ajax({
		method: "POST",
		url: $url,
...
$(document).ready(function()
{
	...
	$(document).on("click", ".periksa-realisasi", function() {
		...
		// Load the form for creating a new realisasi
		$.ajax({
			url: '<?php echo base_url(); ?>kasir/pengajuan/periksa',
			type: 'POST',
	...
	$(document).on("click", ".lanjut-proses", function() {
		...
		// Load the form for viewing catatan
		$.ajax({
			url: '<?php echo base_url(); ?>kasir/pengajuan/konfirmasiLanjutProses',
			type: 'POST',
			data: {id_monitoring:id_monitoring,id_pengajuan_pemohon:id_pengajuan_pemohon},
			beforeSend: function() {
				$('.loading-overlay').show();
			},
			success: function(data) {
	...
	$(document).on("click", ".terima-spj", function() {
		...
		// Load the form for viewing catatan
		$.ajax({
			url: '<?php echo base_url(); ?>kasir/pengajuan/konfirmasiTerimaSpj',
			type: 'POST',
			data: {id_monitoring:id_monitoring,id_pengajuan_pemohon:id_pengajuan_pemohon},
			beforeSend: function() {
				$('.loading-overlay').show();
