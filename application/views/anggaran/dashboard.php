...
?>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Dashboard Pengelola Anggaran</h1>
			<b style="color:red">- UNDER MAINTENANCE -</b>
        ...
        <section class="content">
            <div class="row">
                ...
                foreach ($status_list as $index => $status) {
                    ...
                    $detail_link = base_url('unit_anggaran/monitoring_ajax/?kode_status=' . $status['kode_status']);
                    ?>
