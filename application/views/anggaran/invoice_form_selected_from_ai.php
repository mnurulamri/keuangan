	                ...
	                <div id=data-procost>
                        ...
                        <table class="table" width="100%">
                            ...
                            foreach ($result as $row) {
                                ...
                                echo '<td class="text-right"><input type="text" class="form-control input-sm text-right tax-input" data-id="' . $row['id_pengajuan_pemohon'] . '" data-bruto="' . $row['aktual'] . '" value="' . number_format($row['pph'], 0, ',', ',') . '" min="0"></td>';      
                                echo '<td class="text-right"><input type="text" class="form-control input-sm text-right net-input" data-id="' . $row['id_pengajuan_pemohon'] . '" value="' . number_format($row['netto'], 0, ',', ',') . '" min="0" readonly></td>';     
                                echo '</tr>';   
                                $no++; 
                            }
                            ?>
...
$(document).ready(function()
{
	...
	$(document).on("input change", ".tax-input", function(){
		...
		netInput.val(formatCurrency(net.toFixed(2)));
	});
