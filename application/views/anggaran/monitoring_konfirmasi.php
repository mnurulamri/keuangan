                    ...
                    <div class="row" style="width:99%; margin:0 auto;">
                        ...
                        <div class="col-sm-12 kotakx">
                            ...
                            <div id="approvalForm" class="text-center">
                                <div class="form-group">
                                    <label for="keterangan_anggaran_umko" style="color:#555">Keterangan Persetujuan</label>
                                    <textarea class="form-control" id="anggaran_keterangan" name="anggaran_keterangan" rows="3"><?=$anggaran_keterangan?></textarea>
                                </div>
