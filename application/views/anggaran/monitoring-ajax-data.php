        ...
        <?php if (!empty($posts)): ?>
            ...
            ?>
                <tr>
					...
					<td onclick="toggleDetail('<?=$toggleId?>', '<?=$toggleHeadId?>', '<?=$barisKe?>')" style="<?= $text_decoration; ?>" ><?= dbToTanggal($row['tanggal'] ?? '') ?></td>
                    <td onclick="toggleDetail('<?=$toggleId?>', '<?=$toggleHeadId?>', '<?=$barisKe?>')" style="<?= $text_decoration; ?>" ><?= htmlspecialchars($row['nomor_pengajuan'] ?? '') ?></td>
                    <td onclick="toggleDetail('<?=$toggleId?>', '<?=$toggleHeadId?>', '<?=$barisKe?>')" style="<?= $text_decoration; ?>" ><?= htmlspecialchars($array_deskripsi_dpsj[$row['kode_dpsj']] ?? '') ?></td>
                    <td onclick="toggleDetail('<?=$toggleId?>', '<?=$toggleHeadId?>', '<?=$barisKe?>')" style="<?= $text_decoration; ?>" ><?= htmlspecialchars($row['form'] ?? '') ?></td>
                    <td onclick="toggleDetail('<?=$toggleId?>', '<?=$toggleHeadId?>', '<?=$barisKe?>')" style="<?= $text_decoration; ?>" ><?= htmlspecialchars($row['uraian'] ?? '') ?></td>
                    <!--<td><?= isset($row['nominal_pengajuan']) ? number_format($row['nominal_pengajuan'], 0, '.', ',') : '' ?></td>-->
                    <td onclick="toggleDetail('<?=$toggleId?>', '<?=$toggleHeadId?>', '<?=$barisKe?>')" style="<?= $text_decoration; ?>" class="text-right"><?= isset($komitmen) ? number_format($komitmen, 0, '.', ',') : '' ?></td>
                    <td onclick="toggleDetail('<?=$toggleId?>', '<?=$toggleHeadId?>', '<?=$barisKe?>')" style="<?= $text_decoration; ?>" class="text-right"><?= isset($subtotal_realisasi_main) ? number_format($subtotal_realisasi_main, 0, '.', ',') : '' ?></td>
                    <td>
                    ...
                    <td onclick="toggleDetail('<?=$toggleId?>', '<?=$toggleHeadId?>', '<?=$barisKe?>')" id="status_<?= $row['id'] ?>"><?= nama_status($row['kode_status']) ?? $row['kode_status'] ?></td>
                    <td id="button_<?= $row['id'] ?>">
                        
                        <?php if ($row['kode_status'] == 1 or $row['kode_status'] == 10 or $row['kode_status'] == 66): ?>
