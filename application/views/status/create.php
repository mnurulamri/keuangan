...
<section class="content-header">
    <h1>
        <?= $title ?>
        <small>Tambah Status Baru</small>
    </h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Form Tambah Status</h3>
                </div>
                <!-- /.box-header -->
                <?= form_open('status/create') ?>
                <div class="box-body">
