...
foreach($array_monitoring as $key => $value)
{
    ...
    $html.= '
        ...
        <td>';
        if($posts[$key]['kode_status'] == 51 or $posts[$key]['kode_status'] == 62){
            ...
            $html.='
                    <button class="btn btn-primary btn-xs lanjut-proses" data-id_monitoring="'.$posts[$key]['id'].'" data-id_pengajuan_pemohon="'.$posts[$key]['id_pengajuan_pemohon'].'" data-toggle="modal" data-target="#modal-catatan">Lanjut Proses</button>
                </td>';
        } else {
            $html.= '';
        }
