    ...
    <table class="table table-bordered table-striped" style="color:#444">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    '.$result[0]['korpum_keterangan_disetujui'].'
                </td>
            </tr>
            <tr>
                ...
                <td>
                    '.$result[0]['manajer_keterangan_disetujui'].'
                </td>
            </tr>
            <tr>
                ...
                <td>
                    '.$result[0]['kasir_keterangan_disetujui'].'
                </td>
            </tr>
            <tr>
                ...
                <td>
                    '.$result[0]['verifikator_keterangan_disetujui'].'<br>
                    '.$result[0]['keterangan_retur'].'
                </td>
            </tr>
        </tbody>
    </table>';
