    ...
    <div class="row" style="width:99%; margin:0 auto;">
        ...
        <div class="col-sm-12 kotakx">
            ...
            <div id="approvalForm" class="text-center">
                ...
                <button class="btn btn-success approval" id="setujui" data-id_monitoring="<?=$result_monitoring[0]['id']?>"  data-id_pengajuan_pemohon="<?=$result_monitoring[0]['id_pengajuan_pemohon']?>"><i class="fa fa-check"></i> Proses </button>
            </div>
        </div>
    </div>
</div>
