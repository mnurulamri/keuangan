                    ...
                    <div class="row" style="width:99%; margin:0 auto;">
                        ...
                        <div class="col-sm-12 kotakx">
                            ...
                            <div id="approvalForm" class="text-center">
                                <div class="form-group" class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="manajer_tanggal" name="manajer_tanggal">
                                        </div>
                                    </div>
                                        ...
                                        <div class="bootstrap-timepicker col-sm-4">
                                            <div class="form-groupx">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control timepicker" id="manajer_waktu" name="manajer_waktu" disabled >
                                                </div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
                                ...
                                <button type="button" class="btn btn-warning" id="pending" data-id_pengajuan_pemohon="<?=$id_pengajuan_pemohon?>" data-id_monitoring="<?=$id_monitoring?>"><i class="fa fa-undo"></i> Dikembalikan</button>
                                <button class="btn btn-danger" id="batal" data-id_pengajuan_pemohon="<?=$id_pengajuan_pemohon?>" data-id_monitoring="<?=$id_monitoring?>" data-nama_form="<?=$form?>"><i class="fa fa-minus-circle"></i> Dibatalkan</button>
...
$(document).ready(function()
{
    $('#setujui').on('click', function() {
		...
		var manajer_tanggal = $("#manajer_tanggal").val();
		var manajer_waktu = $("#manajer_waktu").val();
        ...
        $.ajax({
            ...
            data: {
                ...
                nama_form: nama_form,
				manajer_tanggal:$('#manajer_tanggal').val(),
				manajer_waktu:$('#manajer_waktu').val()
            },
            //dataType: 'json',
        ...
        kendali_dokumen(flag_approve='Proses', id_monitoring, manajer_tanggal, manajer_waktu);
    });
    ...
    $("#pending").click(function(){
		...
		if (!confirm("Apakah Anda yakin akan mengembalikan data pengajuan ini?")) {
	        ...
	        $.ajax({
	            url: '<?=base_url("manajer/monitoring/pending")?>',
	            type: 'POST',
	            data: {
	                id_monitoring: id_monitoring,
	                id_pengajuan_pemohon: id_pengajuan_pemohon,
        ...
        kendali_dokumen(flag_approve='Pending', id_monitoring, manajer_tanggal, manajer_waktu);
    });
    ...
    $("#batal").click(function(){
		...
		if (!confirm("Apakah Anda yakin akan membatalkan data pengajuan ini?")) {
	        ...
	        $.ajax({
	            url: '<?=base_url("manajer/monitoring/batal")?>',
	            type: 'POST',
	            data: {
	                id_monitoring: id_monitoring,
	                id_pengajuan_pemohon: id_pengajuan_pemohon,
        ...
        kendali_dokumen(flag_approve='Batal', id_monitoring, manajer_tanggal, manajer_waktu);
    });

    //Datepicker
    $(document).on('focus', '#manajer_tanggal', function(){
        $('#manajer_tanggal').datepicker({
            autoclose: true,
            language: "id",
            format:"DD, d MM yyyy",
            todayHighlight: true,
...
function kendali_dokumen(flag_approve, id_monitoring, manajer_tanggal, manajer_waktu){
    ...
    $.ajax({
        ...
        data: {
            ...
            keterangan: manajer_keterangan,
            kode_status: kode_status,
            tanggal: manajer_tanggal,
            waktu: manajer_waktu
        },
        //dataType: 'json',
        success: function(res) {
