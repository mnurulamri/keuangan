...
//echo '<pre>';print_r($tanggal);echo 'testing';echo '</pre>';
?>
                                            ...
                                            <table class="tablex table-borderedx" id="tabel-rincian">
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td class="total-disetujui text-right"><?=number_format($nominal_pengajuan)?></td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div class="row" style="width:99%; margin:0 auto;">
                        ...
                        <div class="col-sm-12 kotakx">
                            ...
                            <div id="approvalForm" class="text-center">
                                <div class="form-group">
                                    <label for="manajer_tgl_disetujui" style="color:#555">Disetujui Manajer Keuangan dan Anggaran Tanggal</label>
                                    <div class="form-control" id="manajer_tgl_disetujui" name="manajer_tgl_disetujui" rows="3"><?=$manajer_tgl_disetujui?></div>
                                </div>
                                <div class="form-group">
                                    <label for="manajer_keterangan" style="color:#555">Keterangan</label>
                                    <div class="form-control" id="manajer_keterangan" name="manajer_keterangan" rows="3"><?=$manajer_keterangan?></div>
                                </div>
                            </div>
                        </div>
                    </div>
