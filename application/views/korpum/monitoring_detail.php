                                                ...
                                                <tbody>
                                                    ...
                                                    foreach($rincian as $row){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="sisa_anggaran text-right" id="sisa_anggaran_'.$newId.'" data-sisa_anggaran="'.$sisa_anggaran[$kode_kegiatan][$kode_akun][$kode_dana].'">'.number_format($sisa_anggaran[$kode_kegiatan][$kode_akun][$kode_dana]).'</td>
                    ...
                    <div class="row" style="width:99%; margin:0 auto;">
                        ...
                        <div class="col-sm-12 kotak">
                            ...
                            <div id="approvalForm" class="text-center">
                                <div class="form-group">
                                    <label for="korpum_tgl_disetujui" style="color:#555">Disetujui Unit KORPUM Tanggal</label>
                                    <div class="form-controlx" id="korpum_tgl_disetujui" name="korpum_tgl_disetujui" rows="3"><?=$korpum_tgl_disetujui?></div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <label for="keterangan_anggaran_umko" style="color:#555">Keterangan</label>
                                    <div class="form-controlx" id="korpum_keterangan" name="korpum_keterangan" rows="3"><?=$korpum_keterangan?></div>
                                </div>
                            </div>
                        </div>
                    </div>
