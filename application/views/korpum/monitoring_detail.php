                        ...
                        <div class="col-sm-12 kotakx">
                            ...
                            <div id="approvalForm" class="text-center">
                                <div class="form-group">
                                    ...
                                    <div class="form-control" id="korpum_tgl_disetujui" name="korpum_tgl_disetujui" rows="3"><?=$korpum_tgl_disetujui?></div>
                                </div>
                                <div class="form-group">
                                    <label for="keterangan_anggaran_umko" style="color:#555">Keterangan</label>
                                    <div class="form-control" id="korpum_keterangan" name="korpum_keterangan" rows="3"><?=$korpum_keterangan?></div>
                                </div>
                            </div>
                        </div>
                    </div>
