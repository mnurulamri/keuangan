<?php 
//echo '<pre>'; print_r($result_monitoring); print_r($result_monitoring[0]['id']); 
...
//echo $nomor_pengajuan = isset($result_monitoring[0]['nomor_pengajuan']) ? $result[0]['nomor_pengajuan'] : '';
...
<div class="containerx">
    ...
    <div class="kotakx">
        <table style="margin:auto; box-shadow: 0 0 20px rgba(0, 0, 0, 0.15);" id="tabel-rincian">
            <label for="">&nbsp;</label>
            <thead>
                <tr>
                ...
                <tr style="background-color:#4CAF50; color:#fff">
                    <td rowspan="2" style="padding:1px; text-align:center;">NO</td>
                    <td rowspan="2" style="padding:1px; text-align:center;">TANGGAL</td>
                    <td rowspan="2" style="padding:1px; text-align:center;">KETERANGAN</td>
                    <td colspan="3" style="padding:1px; text-align:center;">SATUAN</td>
                    <td rowspan="2" style="padding:1px; text-align:center;">BRUTO</td>
                    <td colspan="2" style="padding:1px; text-align:center;">TARIF PAJAK</td>
                    <td rowspan="2" style="padding:1px; text-align:center;">NETTO (Rp)</td>
                    <td rowspan="2" style="padding:1px; text-align:center;">CHECK LIST</td>
					<td rowspan="2" style="padding:1px; text-align:center;">Catatan Perbaikan</td>
					<td rowspan="2" style="padding:1px; text-align:center;">Simpan<br>Catatan Perbaikan</td>
                </tr>
                <tr style="background-color:#4CAF50; color:#fff"> 
                    <td style="padding:1px; text-align:center;">VOL</td>
                    <td style="padding:1px; text-align:center;">KET VOL</td>
                    <td style="padding:1px; text-align:center;">HARGA (Rp)</td>
                    <td style="padding:1px; text-align:center;">%</td>
                    <td style="padding:1px;">PPh (Rp)</td>
                </tr>            
            </thead>
            <tbody>
            <?php
            ...
            foreach($result_realisasi as $key => $row) {
                ...
                echo '
					<td contenteditable="true" class="catatan-perbaikan">'.$row['catatan_perbaikan'].'</td>
					<td >
						<button class="btn btn-success btn-sm simpan-catatan-perbaikan" data-id="'.$row['id'].'"><i class="fa fa-floppy-o"></i> Simpan </button>
					</td>			
				</tr>';
                $n++;
            }
   ...
   <hr>
    <div class="row" style="width:99%; margin:0 auto;">
        ...
        if($result_monitoring[0]['kode_status'] == 13) {
            $korpum_keterangan = isset($result_monitoring[0]['korpum_realisasi_keterangan_disetujui']) ? $result_monitoring[0]['korpum_realisasi_keterangan_disetujui'] : '';
        } else if($result_monitoring[0]['kode_status'] == 41) {            
            $korpum_keterangan = isset($result_monitoring[0]['korpum_realisasi_keterangan_pending']) ? $result_monitoring[0]['korpum_realisasi_keterangan_pending'] : '';
        } else {
            $korpum_keterangan = '';
        }
        ?>
        <div class="col-sm-12 kotakx">
            ...
            <div id="approvalForm" class="text-center">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="verifikator_keterangan" name="verifikator_keterangan" rows="3"><?=$korpum_keterangan?></textarea>
                </div>
                ...
                <button class="btn btn-success simpan-catatan" id="simpan-catatan" data-id_monitoring="<?=$result_monitoring[0]['id']?>"  data-id_pengajuan_pemohon="<?=$result_monitoring[0]['id_pengajuan_pemohon']?>"><i class="fa fa-check"></i> Simpan Catatan </button>
            </div>
        </div>
    </div>
</div>-->
...
$(document).ready(function()
{
	...
	$(".simpan-catatan-perbaikan").click(function()
    {
		var id = $(this).data('id');
		var catatan_perbaikan = $(this).parent().parent().find(".catatan-perbaikan").text()
		//alert(teks)
		$.ajax({
	        url: '<?=base_url("verifikator/monitoring/updateCatatanPerbaikan")?>',
	        type: 'POST',
	        data: {
				id: id,
...
function kendali_dokumen(flag_approve, id_monitoring){
    ...
    $.ajax({
        ...
        data: {
			id_monitoring: id_monitoring,
            kd_pengajuan: kd_pengajuan,
            keterangan: verifikator_keterangan,
            kode_status: kode_status
        },
        //dataType: 'json',
        success: function(res) {
