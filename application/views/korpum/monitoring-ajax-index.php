...
{  
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>korpum/monitoring_ajax/data/0',
...
{              
    ...
    $url = "<?=base_url().'korpum/monitoring_ajax/data/'?>"+page;
...
$(document).ready(function()
{
	...
	$(document).on("click",".approval", function(){
		...
		$("#approval-title").html('<div class="text-info text-center"><strong>Proses Otorisasi Koordinator PUM</strong></div>');

		// ambil data form edit pengajuan menggunakan AJAX
        $.ajax({
            url: "<?=base_url()?>index.php/korpum/monitoring/konfirmasiApproval",
            type: "POST",
	...
	$(document).on("click",".detail", function(){
        ...
        // set title modal approval
		$("#approval-title").html('<div class="text-danger text-center"><strong>Data Pengajuan Sudah Disetujui Koodinator PUM</strong></div>');
